...
class Play extends React.Component {
    ...
    changeCouleur(event) {
        ...
        if(this.state.r === true){
            ...
            this.changeJaune(x)
        }else if(this.state.validation === true && x.parentNode.parentNode.id === "plateau2"){
            this.changeGris(x)
        }
    }
    changeGris(e){ //Grille adverse
        if(e.className === "caseBataille")
            e.className = (e.className === "caseBataille") ? "caseBataille6" : "caseBataille"; 
    }
    changeRouge(e){
    ...
    transformTab(){ //parse la grille en matrice + validation de tous les bateaux poses
        ...
        if(this.state.r_nb === this.state.r_max && this.state.b_nb === this.state.b_max && 
            ...
            this.setState({validation: true, r: false, b: false, v: false, j: false})
        }else {
    ...
    render(){
        return(
            <div id="jeu">
                <p id="titre">Bataille Navale</p>
                <p id="moi">Ta grille</p>
                <p id="adv">Ton adversaire</p>
                <br/>
                ...
                <div className="bouton">
                    <button type="button" id="b1" value="Bateau1" onClick={this.bateau1}>Bateau1</button>
                    <button type="button" id="b2" value="Bateau2" onClick={this.bateau2}>Bateau2</button>
                    <button type="button" id="b3" value="Bateau3" onClick={this.bateau3}>Bateau3</button>
                    <button type="button" id="b4" value="Bateau4" onClick={this.bateau4}>Bateau4</button>
                    <br/>
                    <button type="button" id="sens" value="Sens" onClick={this.horizontal}>Sens</button>
                    <button type="button" id="jouer" value="Valider" onClick={this.transformTab}>Valider</button>
                </div>
            </div>
        );
    }
